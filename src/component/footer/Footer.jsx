      ...
      <div className="footer-container">
        <div className="about-footer">
          ...
          <div className="Contact-contribute-container">
              <a href="mailto:abhijeettirkey@gmail.com" className="about-us-title" target="blank">Contact Us</a>   
              <a href="https://github.com/abhijeet/NoteSharing" className="about-us-title" target="blank">Want to contribute</a>   
          </div>
          </div>
